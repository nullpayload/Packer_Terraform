...
Packer
    ...
    local pam login is used to authenticate to the proxmox API.  I think I hit this issue, but didn't go back to this after switching to local pam auth. https://bugzilla.proxmox.com/show_bug.cgi?id=4344
